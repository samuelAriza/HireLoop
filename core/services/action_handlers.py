...
class PortfolioUpdateHandler(ActionHandler):
    ...
    def handle(self, request: HttpRequest, **kwargs) -> HttpResponse:
        ...
        try:
            ...
            # Check ownership
            print(f"DEBUG PortfolioUpdateHandler - Portfolio user: {portfolio_item.freelancer.user}")
...
class PortfolioDeleteHandler(ActionHandler):
    ...
    def handle(self, request: HttpRequest, **kwargs) -> HttpResponse:
        ...
        try:
            ...
            # Check ownership
            print(f"DEBUG PortfolioDeleteHandler - Portfolio user: {portfolio_item.freelancer.user}")
