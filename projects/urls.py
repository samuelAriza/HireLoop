...
urlpatterns = [
    ...
    path('<uuid:project_id>/assignments/create/', ProjectAssignmentCreateView.as_view(), name='assignment_create'),
    path('assignments/<uuid:pk>/update/', ProjectAssignmentUpdateView.as_view(), name='assignment_update'),
    path('<uuid:pk>/', ProjectDetailView.as_view(), name='project_detail'),
    path('<uuid:project_id>/apply/', ProjectApplicationCreateView.as_view(), name='application_create'),
    path('applications/<uuid:pk>/accept/', ProjectApplicationAcceptView.as_view(), name='application_accept'),
    path('applications/<uuid:pk>/reject/', ProjectApplicationRejectView.as_view(), name='application_reject'),
]